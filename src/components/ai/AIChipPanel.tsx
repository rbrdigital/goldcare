...
export default function AIChipPanel({
  ...
  return (
    <TooltipProvider>
      <div
        className={cn(
          // flex row layout with flex-start alignment and wrapping
          "w-full rounded-[20px] px-4 py-2 flex flex-row items-start flex-wrap gap-3 transition-all duration-300",
        ...
        {...rest}
      >
        {/* New GoldCare AI icon with golden gradient and tooltip */}
        <Tooltip>
