  ...
  if (!isExpanded) {
    return (
      <button
        ...
        className={cn(
          "mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface border border-border hover:border-primary/50 transition-colors text-sm text-fg-muted hover:text-fg focus:outline-none focus:ring-2 focus:ring-primary",
          className
        )}
      >
