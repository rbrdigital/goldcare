...
export function AIImagingOrderBox({ onDraft, isLoading = false }: AIImagingOrderBoxProps) {
  ...
  return (
    <Card className="p-6 bg-gradient-to-br from-surface via-surface to-surface/80 border-2 border-primary/20 shadow-lg" data-testid="ai-imaging-order-box">
      {/* Header */}
      ...
      <div className="space-y-6">
        <div className="relative">
          <AutosizeTextarea
            ...
            placeholder="Describe the imaging (e.g., 'CT head without contrast; Dx: head trauma; stat')."
            minRows={3}
            maxRows={6}
