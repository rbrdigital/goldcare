...
export function AIImagingOrderBox({ onDraft, isLoading = false }: AIImagingOrderBoxProps) {
  ...
  return (
    <Card className="p-8 bg-gradient-to-br from-surface/50 via-surface to-surface/80 border border-border/50 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-sm" data-testid="ai-imaging-order-box">
      {/* Header */}
