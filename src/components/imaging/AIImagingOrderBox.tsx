...
export function AIImagingOrderBox({ onDraft, isLoading = false }: AIImagingOrderBoxProps) {
  ...
  return (
    <Card className="p-10 bg-gradient-to-br from-surface/60 via-surface/95 to-surface/80 border border-border/40 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] backdrop-blur-sm" data-testid="ai-imaging-order-box">
      {/* Header */}
      <div className="flex flex-col items-center gap-4 mb-10">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-fg-muted mt-0.5">Draft imaging orders with natural language</p>
        </div>
      </div>
